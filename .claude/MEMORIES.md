...
[2026-05-21] core/load.xml, locale/load.xml, locale/enUS.lua, locale/ruRU.lua реализованы (стабы локали).
[2026-05-21] Ожидают реализации: core/minimap.lua (LibDBIcon, LDB-объект, show/hide кнопки).